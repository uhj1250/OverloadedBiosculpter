...
namespace BiosculpterAcceleration
{
    ...
    public class Gizmo_BioOverloadConfig : Gizmo
    {
        ...
        protected List<CompBiosculpterOverload> selected = new List<CompBiosculpterOverload>();

        protected static bool clicked = false;
        protected static CompBiosculpterOverload clickedgizmo = null;
        

        public void AddSelected(CompBiosculpterOverload comp)
        {
            selected.Add(comp);
        }
        ...
        {
            return other is Gizmo_BioOverloadConfig;
        }
